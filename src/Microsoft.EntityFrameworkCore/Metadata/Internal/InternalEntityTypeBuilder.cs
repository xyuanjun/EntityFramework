...
namespace Microsoft.EntityFrameworkCore.Metadata.Internal
{
    ...
    public class InternalEntityTypeBuilder : InternalMetadataItemBuilder<EntityType>
    {
            ...
            bool useDefaultType = false)
        {
            ...
            var referencedPropertiesList = referencedProperties;
            if (referencedPropertiesList != null
                && referencedPropertiesList.Count != propertyNames.Count)
            {
            ...
            for (var i = 0; i < propertyNames.Count; i++)
            {
                ...
                if (property == null)
                {
                    ...
                    var type = referencedPropertiesList == null
                        ? useDefaultType ? typeof(int) : null
                        : referencedPropertiesList[i].ClrType;
