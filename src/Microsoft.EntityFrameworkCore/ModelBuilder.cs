...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public class ModelBuilder : IInfrastructure<InternalModelBuilder>
    {
        ...
        /// <summary>
        ///     Applies configuration that is defined in an <see cref="EntityTypeConfiguration{TEntity}"/> instance.
        /// </summary>
        /// <typeparam name="TEntity"> The entity type to be configured. </typeparam>
        ...
        ///     The same <see cref="ModelBuilder" /> instance so that additional configuration calls can be chained.
        /// </returns>
        public virtual ModelBuilder ApplyConfiguration<TEntity>([NotNull] EntityTypeConfiguration<TEntity> configuration)
            where TEntity : class
        {
