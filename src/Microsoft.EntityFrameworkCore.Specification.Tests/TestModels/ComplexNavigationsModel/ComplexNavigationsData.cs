...
namespace Microsoft.EntityFrameworkCore.Specification.Tests.TestModels.ComplexNavigationsModel
{
    ...
    {
        private static Level1[] _levelOnes;
        private static Level2[] _levelTwos;
        private static Level3[] _levelThrees;
        private static Level4[] _levelFours;
        ...
        public static void WireUpInversePart2(Level1[] l1s, Level2[] l2s, Level3[] l3s, Level4[] l4s)
        {
            ...
            l3s[4].OneToOne_Optional_FK_Inverse = l2s[5];
            l3s[2].OneToOne_Optional_FK_Inverse = l2s[7];
            l3s[0].OneToOne_Optional_FK_Inverse = l2s[9];
